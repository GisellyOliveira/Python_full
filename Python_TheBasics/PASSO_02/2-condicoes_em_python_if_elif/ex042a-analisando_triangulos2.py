...
if r1 < r2 + r3  and r2 < r3 + r1 and r3 < r1 + r2:
    print('PARABÉNS!!! As suas retas podem formar um TRIÂNGULO ', end='')
    # Vamos inserir uma outra condicional dentro da condicional:
    # poderíamos usar-> if r1 == r2 and r2 == r3:
    if r1 == r2 == r3:
        print('EQUILÁTERO!')
        # SE USARMOS SOMENTE-> r1 != r3 != r3: -> o programa não vai checar caso r1 == r3 e vai dar erro.
    elif r1 != r3 != r3 != r1:
        print('ESCALENO!')
    else:
        print('ISÓSCELES!')
